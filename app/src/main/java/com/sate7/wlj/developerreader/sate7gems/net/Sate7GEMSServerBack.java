...
public class Sate7GEMSServerBack implements NetBase {
    private OkHttpClient okHttpClient;

    private static class Sate7GEMSServerHolder {
        private static Sate7GEMSServerBack mInstance = new Sate7GEMSServerBack();
    }

    private Sate7GEMSServerBack() {
    ...
    public static Sate7GEMSServerBack getInstance() {
